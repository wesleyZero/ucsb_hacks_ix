...
while True:
	...
	if frame is None: break #end of the video file
	...
	if left_pupil: print("_")
	else: print(f"frame # = {total_frames} no eyes {no_eye_duration}")
	...
	# 	no_eye_duration = 1
		...
		if len(no_eye_times): durations[no_eye_times[-1]] = no_eye_duration - 1
		no_eye_duration = 1
	# else:
		# no_eye_duration = 1
